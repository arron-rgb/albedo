...
public class MenuResourceIntTest {
  ...
  public void getMenu() throws Exception {
    ...
    restMenuMockMvc.perform(get(DEFAULT_API_URL + "{id}", menu.getId())).andExpect(status().isOk())
      ...
      .andExpect(jsonPath("$.data.icon").value(DEFAULT_ICON)).andExpect(jsonPath("$.data.hidden").value(DEFAULT_HIDDEN))
      ...
      .andExpect(jsonPath("$.data.type").value(DEFAULT_TYPE)).andExpect(jsonPath("$.data.path").value(DEFAULT_PATH))
