...
public class JobResourceIntTest {
  ...
  public void setup() {
    ...
    this.restJobMockMvc = MockMvcBuilders.standaloneSetup(jobResource)
      ...
      .setControllerAdvice(globalExceptionHandler).setConversionService(TestUtil.createFormattingConversionService())
  ...
  public void updateJob() throws Exception {
    ...
    ClassUtil.updateObj(updatedJob,
      Lists.newArrayList(Job.F_NAME, Job.F_GROUP, Job.F_INVOKETARGET, Job.F_CRONEXPRESSION, Job.F_MISFIREPOLICY,
        Job.F_CONCURRENT, Job.F_AVAILABLE, Job.F_DESCRIPTION),
