...
public class AccoutJwtResource extends BaseResource {
    ...
    try {
      ...
      if (ae instanceof BadCredentialsException) {
        ...
        if (level1) {
          ...
          cacheObject = 0;
          // RedisUtil.setCacheObject(SecurityConstants.DEFAULT_LOGIN_AFTER_24_KEY +loginVo.getUsername(),
          // DateUtil.addDays(PublicUtil.getCurrentDate(), 1), 1, TimeUnit.DAYS);
        }
  ...
  public ResponseEntity<Result> logout(
    @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authHeader, HttpServletRequest request,
