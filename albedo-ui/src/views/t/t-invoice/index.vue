  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
          ...
          <el-input class="filter-item input-small" v-model="query.type" clearable size="small" placeholder="输入0-个人，1-企业搜索" @keyup.enter.native="toQuery" />
          <el-input class="filter-item input-small" v-model="query.name" clearable size="small" placeholder="输入企业名称/个人名称搜索" @keyup.enter.native="toQuery" />
          <el-input class="filter-item input-small" v-model="query.taxNum" clearable size="small" placeholder="输入公司税号搜索" @keyup.enter.native="toQuery" />
          <el-input class="filter-item input-small" v-model="query.companyLocation" clearable size="small" placeholder="输入注册地址搜索" @keyup.enter.native="toQuery" />
          <el-input class="filter-item input-small" v-model="query.companyPhone" clearable size="small" placeholder="输入公司电话搜索" @keyup.enter.native="toQuery" />
          <el-input class="filter-item input-small" v-model="query.accountBank" clearable size="small" placeholder="输入开户公司搜索" @keyup.enter.native="toQuery" />
        <rrOperation />
      </div>
    ...
    >
      <el-form ref="form" :inline="true" :model="form" label-width="120px" size="small">
        ...
        <el-form-item label="0-个人，1-企业" prop="type" :rules="[{required: true,message: '请输入0-个人，1-企业', trigger: 'blur'},{min: 0,max: 1,message: '长度在 0 到 1 个字符', trigger: 'blur'},]">
              <el-input v-model="form.type" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="企业名称/个人名称" prop="name" :rules="[{required: true,message: '请输入企业名称/个人名称', trigger: 'blur'},{min: 0,max: 255,message: '长度在 0 到 255 个字符', trigger: 'blur'},]">
        ...
        <el-form-item label="注册地址" prop="companyLocation" :rules="[{min: 0,max: 255,message: '长度在 0 到 255 个字符', trigger: 'blur'},]">
              <el-input v-model="form.companyLocation" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="公司电话" prop="companyPhone" :rules="[{min: 0,max: 255,message: '长度在 0 到 255 个字符', trigger: 'blur'},]">
              <el-input v-model="form.companyPhone" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="开户公司" prop="accountBank" :rules="[{min: 0,max: 255,message: '长度在 0 到 255 个字符', trigger: 'blur'},]">
              <el-input v-model="form.accountBank" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="开户账号" prop="accountNumber" :rules="[{min: 0,max: 32,message: '长度在 0 到 32 个字符', trigger: 'blur'},]">
    ...
    >
      ...
      <el-table-column align="center" label="0-个人，1-企业" :show-overflow-tooltip="true" prop="type" />
...
<script>
import crudTInvoice from '@/views/t/t-invoice/t-invoice-service'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 't_invoice', crudMethod: { ...crudTInvoice }})
  },
