  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
                <el-input class="filter-item input-small" v-model="query.companyName" clearable size="small" placeholder="输入企业名称搜索" @keyup.enter.native="toQuery" />
          <el-input class="filter-item input-small" v-model="query.name" clearable size="small" placeholder="输入姓名搜索" @keyup.enter.native="toQuery" />
        <rrOperation />
      </div>
    ...
    >
      <el-form ref="form" :inline="true" :model="form" label-width="120px" size="small">
        <el-form-item label="企业名称" prop="companyName" :rules="[{min: 0,max: 32,message: '长度在 0 到 32 个字符', trigger: 'blur'},]">
        ...
        <el-form-item label="处理状态" prop="status" :rules="[{min: 0,max: 100,message: '长度在 0 到 100 个字符', trigger: 'blur'},]">
