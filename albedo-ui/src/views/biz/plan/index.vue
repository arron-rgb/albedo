  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
                <el-input class="filter-item input-small" v-model="query.name" clearable size="small" placeholder="输入套餐名搜索" @keyup.enter.native="toQuery" />
        <rrOperation />
      </div>
    ...
    >
      <el-form ref="form" :inline="true" :model="form" label-width="120px" size="small">
        ...
        <el-form-item label="历史版本数" prop="history" :rules="[{validator:validateDigits},]">
              <el-input v-model="form.history" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="虚拟人物" prop="anchorAmount" :rules="[{validator:validateDigits},]">
              <el-input v-model="form.anchorAmount" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="虚拟场景个数" prop="envAmount" :rules="[{validator:validateDigits},]">
              <el-input v-model="form.envAmount" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="存储空间，单位GB" prop="anchorAmountPlus" :rules="[{validator:validateDigits},]">
              <el-input v-model="form.anchorAmountPlus" class="input-small"></el-input>
        
        </el-form-item>
        <el-form-item label="存储空间，单位GB" prop="envAmountPlus" :rules="[{validator:validateDigits},]">
              <el-input v-model="form.envAmountPlus" class="input-small"></el-input>
    ...
    >
      ...
      <el-table-column align="center" label="人物/场景可修改次数" :show-overflow-tooltip="true" prop="editTime" />
      <el-table-column align="center" label="存储空间，单位GB" :show-overflow-tooltip="true" prop="storage" />
      <el-table-column align="center" label="历史版本数" :show-overflow-tooltip="true" prop="history" />
      <el-table-column align="center" label="虚拟人物" :show-overflow-tooltip="true" prop="anchorAmount" />
      <el-table-column align="center" label="虚拟场景个数" :show-overflow-tooltip="true" prop="envAmount" />
      <el-table-column align="center" label="存储空间，单位GB" :show-overflow-tooltip="true" prop="anchorAmountPlus" />
      <el-table-column align="center" label="存储空间，单位GB" :show-overflow-tooltip="true" prop="envAmountPlus" />
