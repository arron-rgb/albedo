...
public class RedisSessionRegistry implements SessionRegistry, ApplicationListener<SessionDestroyedEvent> {
  ...
  public List<Object> getAllPrincipals() {
    if (CollectionUtils.isNotEmpty(redisTemplate.boundHashOps(PRINCIPALS).keys())) {
      return new ArrayList<>(Objects.requireNonNull(redisTemplate.boundHashOps(PRINCIPALS).keys()));
    }
