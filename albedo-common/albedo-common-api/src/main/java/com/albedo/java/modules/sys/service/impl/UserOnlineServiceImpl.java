...
public class UserOnlineServiceImpl extends BaseServiceImpl<UserOnlineRepository, UserOnline>
  ...
  public void saveByEvent(UserOnline userOnline) {
    LambdaQueryWrapper<UserOnline> wrapper = Wrappers.lambdaQuery();
    wrapper.and(inner -> inner.eq(UserOnline::getUserId, userOnline.getUserId()).or().eq(UserOnline::getSessionId,
